...
int main(int argc, char *argv[]) {
    ...
    //Eingefügt für Testzwecke!!!!
    
    argc = 4;
    
    argv[1] = "/Users/mariuskemmling/NetBeansProjects/bs-uebung-template-v0.3/container.bin";
    argv[2] = "/Users/mariuskemmling/NetBeansProjects/bs-uebung-template-v0.3/log.txt";
    argv[3] = "mount-dir16";
